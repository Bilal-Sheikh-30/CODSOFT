...
int main() {
    ...
    // Redirect standard output to a file named "database.txt"
    freopen("database.txt", "a", stdout);
    ...
    if (curl) {
        ...
        const char *url = "https://api.openweathermap.org/data/2.5/forecast?lat=24.86080000&lon=67.01040000&appid=960ab4072cce45cce5e399e8453ed270";
